...
namespace Soenneker.HighLevel.OpenApiClient.Models
{
    ...
    public partial class CreateShippingRateDto : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public global::Soenneker.HighLevel.OpenApiClient.Models.CreateShippingRateDto_altType? AltType { get; set; }
        ...
        public global::Soenneker.HighLevel.OpenApiClient.Models.CreateShippingRateDto_conditionType? ConditionType { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.HighLevel.OpenApiClient.Models.CreateShippingRateDto"/> and sets the default values.
        /// </summary>
        public CreateShippingRateDto()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.HighLevel.OpenApiClient.Models.CreateShippingRateDto"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.HighLevel.OpenApiClient.Models.CreateShippingRateDto CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.HighLevel.OpenApiClient.Models.CreateShippingRateDto();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "altType", n => { AltType = n.GetEnumValue<global::Soenneker.HighLevel.OpenApiClient.Models.CreateShippingRateDto_altType>(); } },
                { "amount", n => { Amount = n.GetDoubleValue(); } },
                { "conditionType", n => { ConditionType = n.GetEnumValue<global::Soenneker.HighLevel.OpenApiClient.Models.CreateShippingRateDto_conditionType>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.HighLevel.OpenApiClient.Models.CreateShippingRateDto_altType>("altType", AltType);
            writer.WriteDoubleValue("amount", Amount);
            writer.WriteEnumValue<global::Soenneker.HighLevel.OpenApiClient.Models.CreateShippingRateDto_conditionType>("conditionType", ConditionType);
