...
using System;
namespace Soenneker.HighLevel.OpenApiClient.Marketplace
{
    /// <summary>
    /// Builds and executes requests for operations under \marketplace
    /// </summary>
    ...
    public partial class MarketplaceRequestBuilder : BaseRequestBuilder
    {
        ...
        public MarketplaceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/marketplace", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.HighLevel.OpenApiClient.Marketplace.MarketplaceRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MarketplaceRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/marketplace", rawUrl)
        {
        }
    }
}
