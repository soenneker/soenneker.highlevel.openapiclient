...
using System;
namespace Soenneker.HighLevel.OpenApiClient.Marketplace.App.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \marketplace\app\{appId}
    /// </summary>
    ...
    public partial class WithAppItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public WithAppItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/marketplace/app/{appId}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.HighLevel.OpenApiClient.Marketplace.App.Item.WithAppItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithAppItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/marketplace/app/{appId}", rawUrl)
        {
        }
    }
}
