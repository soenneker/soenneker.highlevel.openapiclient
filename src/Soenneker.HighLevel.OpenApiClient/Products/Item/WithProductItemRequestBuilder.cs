...
namespace Soenneker.HighLevel.OpenApiClient.Products.Item
{
    ...
    public partial class WithProductItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public WithProductItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/products/{productId}{?sendWishlistStatus*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.HighLevel.OpenApiClient.Products.Item.WithProductItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithProductItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/products/{productId}{?sendWishlistStatus*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.DELETE, "{+baseurl}/products/{productId}?locationId={locationId}{&sendWishlistStatus*}", PathParameters);
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.GET, "{+baseurl}/products/{productId}?locationId={locationId}{&sendWishlistStatus*}", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
