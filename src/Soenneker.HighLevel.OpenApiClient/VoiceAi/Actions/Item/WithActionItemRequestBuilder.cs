...
namespace Soenneker.HighLevel.OpenApiClient.VoiceAi.Actions.Item
{
    ...
    public partial class WithActionItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public WithActionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/voice-ai/actions/{actionId}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.HighLevel.OpenApiClient.VoiceAi.Actions.Item.WithActionItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithActionItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/voice-ai/actions/{actionId}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.HighLevel.OpenApiClient.Models.VoiceAiUpdateActionResponseDto"/></returns>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.HighLevel.OpenApiClient.Models.VoiceAiUpdateActionResponseDto?> PutAsync(global::Soenneker.HighLevel.OpenApiClient.Models.UpdateSingleActionDto body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.HighLevel.OpenApiClient.Models.VoiceAiUpdateActionResponseDto> PutAsync(global::Soenneker.HighLevel.OpenApiClient.Models.UpdateSingleActionDto body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.HighLevel.OpenApiClient.Models.VoiceAiUpdateActionResponseDto>(requestInfo, global::Soenneker.HighLevel.OpenApiClient.Models.VoiceAiUpdateActionResponseDto.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Delete an existing action from a voice AI agent. This permanently removes the action and its configuration.
        /// </summary>
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.DELETE, "{+baseurl}/voice-ai/actions/{actionId}?agentId={agentId}&locationId={locationId}", PathParameters);
