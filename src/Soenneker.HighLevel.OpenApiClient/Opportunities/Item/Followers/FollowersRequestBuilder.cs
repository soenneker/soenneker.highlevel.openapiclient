...
namespace Soenneker.HighLevel.OpenApiClient.Opportunities.Item.Followers
{
    ...
    public partial class FollowersRequestBuilder : BaseRequestBuilder
    {
        ...
        public FollowersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/opportunities/{id}/followers", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.HighLevel.OpenApiClient.Opportunities.Item.Followers.FollowersRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public FollowersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/opportunities/{id}/followers", rawUrl)
        {
        }
        /// <summary>
        /// Remove Followers
