...
namespace Soenneker.HighLevel.OpenApiClient.PhoneSystem.Numbers.Location.Item
{
    ...
    public partial class WithLocationItemRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <exception cref="global::Soenneker.HighLevel.OpenApiClient.Models.Phone_system_active_numbers_400">When receiving a 400 status code</exception>
        ...
        /// <exception cref="global::Soenneker.HighLevel.OpenApiClient.Models.Phone_system_active_numbers_404">When receiving a 404 status code</exception>
        /// <exception cref="global::Soenneker.HighLevel.OpenApiClient.Models.Phone_system_active_numbers_500">When receiving a 500 status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.HighLevel.OpenApiClient.Models.Phone_system_active_numbers_200?> GetAsync(Action<RequestConfiguration<global::Soenneker.HighLevel.OpenApiClient.PhoneSystem.Numbers.Location.Item.WithLocationItemRequestBuilder.WithLocationItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.HighLevel.OpenApiClient.Models.Phone_system_active_numbers_200> GetAsync(Action<RequestConfiguration<global::Soenneker.HighLevel.OpenApiClient.PhoneSystem.Numbers.Location.Item.WithLocationItemRequestBuilder.WithLocationItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "400", global::Soenneker.HighLevel.OpenApiClient.Models.Phone_system_active_numbers_400.CreateFromDiscriminatorValue },
                { "401", global::Soenneker.HighLevel.OpenApiClient.Models.Common_schemas_UnauthorizedDTO.CreateFromDiscriminatorValue },
                { "404", global::Soenneker.HighLevel.OpenApiClient.Models.Phone_system_active_numbers_404.CreateFromDiscriminatorValue },
                { "500", global::Soenneker.HighLevel.OpenApiClient.Models.Phone_system_active_numbers_500.CreateFromDiscriminatorValue },
            };
            return await RequestAdapter.SendAsync<global::Soenneker.HighLevel.OpenApiClient.Models.Phone_system_active_numbers_200>(requestInfo, global::Soenneker.HighLevel.OpenApiClient.Models.Phone_system_active_numbers_200.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Retrieve a paginated list of active phone numbers for a specific location. Supports filtering, pagination, and optional exclusion of number pool assignments.
        /// </summary>
