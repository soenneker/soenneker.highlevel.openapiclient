...
namespace Soenneker.HighLevel.OpenApiClient.Locations.Item
{
    ...
    public partial class WithLocationItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public WithLocationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/locations/{locationId}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.HighLevel.OpenApiClient.Locations.Item.WithLocationItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithLocationItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/locations/{locationId}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.DELETE, "{+baseurl}/locations/{locationId}?deleteTwilioAccount={deleteTwilioAccount}", PathParameters);
