...
namespace Soenneker.HighLevel.OpenApiClient.Payments.Integrations.Provider.Whitelabel
{
    ...
    public partial class WhitelabelRequestBuilder : BaseRequestBuilder
    {
        ...
        public WhitelabelRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/payments/integrations/provider/whitelabel{?limit*,offset*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.HighLevel.OpenApiClient.Payments.Integrations.Provider.Whitelabel.WhitelabelRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WhitelabelRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/payments/integrations/provider/whitelabel{?limit*,offset*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.GET, "{+baseurl}/payments/integrations/provider/whitelabel?altId={altId}&altType={altType}{&limit*,offset*}", PathParameters);
