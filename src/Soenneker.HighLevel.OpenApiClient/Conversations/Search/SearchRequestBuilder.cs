...
namespace Soenneker.HighLevel.OpenApiClient.Conversations.Search
{
    ...
    public partial class SearchRequestBuilder : BaseRequestBuilder
    {
        ...
        public SearchRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/conversations/search?locationId={locationId}{&assignedTo*,contactId*,endDate*,followers*,id*,lastMessageAction*,lastMessageDirection*,lastMessageType*,limit*,mentions*,query*,scoreProfile*,scoreProfileMax*,scoreProfileMin*,sort*,sortBy*,sortScoreProfile*,startAfterDate*,startDate*,status*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.HighLevel.OpenApiClient.Conversations.Search.SearchRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SearchRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/conversations/search?locationId={locationId}{&assignedTo*,contactId*,endDate*,followers*,id*,lastMessageAction*,lastMessageDirection*,lastMessageType*,limit*,mentions*,query*,scoreProfile*,scoreProfileMax*,scoreProfileMin*,sort*,sortBy*,sortScoreProfile*,startAfterDate*,startDate*,status*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
            ...
            public string ContactId { get; set; }
#endif
            /// <summary>End date filter for dateAdded field (Unix timestamp in milliseconds)</summary>
...
#nullable restore
            ...
            public global::Soenneker.HighLevel.OpenApiClient.Models.SearchConversationLastMessageActionParameter? LastMessageAction { get; set; }
            /// <summary>Direction of the last message in the conversation as string.</summary>
            [QueryParameter("lastMessageDirection")]
            public global::Soenneker.HighLevel.OpenApiClient.Models.SearchConversationLastMessageDirectionParameter? LastMessageDirection { get; set; }
            /// <summary>Type of the last message in the conversation as a string</summary>
            [QueryParameter("lastMessageType")]
            public global::Soenneker.HighLevel.OpenApiClient.Models.SearchConversationLastMessageTypeParameter? LastMessageType { get; set; }
...
#nullable restore
            ...
            [QueryParameter("sort")]
            public global::Soenneker.HighLevel.OpenApiClient.Models.SearchConversationSortParameter? Sort { get; set; }
            /// <summary>The sorting of the conversation to be filtered as - manual messages or all messages</summary>
            [QueryParameter("sortBy")]
            public global::Soenneker.HighLevel.OpenApiClient.Models.SearchConversationSortByParameter? SortBy { get; set; }
...
#nullable restore
            ...
            public string StartAfterDate { get; set; }
#endif
            /// <summary>Start date filter for dateAdded field (Unix timestamp in milliseconds)</summary>
            [QueryParameter("startDate")]
            public double? StartDate { get; set; }
            /// <summary>The status of the conversation to be filtered - all, read, unread, starred </summary>
            [QueryParameter("status")]
            public global::Soenneker.HighLevel.OpenApiClient.Models.SearchConversationStatusParameter? Status { get; set; }
        }
    }
}
