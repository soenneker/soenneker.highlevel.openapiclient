...
namespace Soenneker.HighLevel.OpenApiClient.Invoices.Estimate.Template
{
    ...
    public partial class TemplateRequestBuilder : BaseRequestBuilder
    {
        ...
        public TemplateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/invoices/estimate/template{?search*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.HighLevel.OpenApiClient.Invoices.Estimate.Template.TemplateRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TemplateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/invoices/estimate/template{?search*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.GET, "{+baseurl}/invoices/estimate/template?altId={altId}&altType={altType}&limit={limit}&offset={offset}{&search*}", PathParameters);
